...
- there is no strictly defined placeholder for elevation in RFC 7946 geoJSON (elevation MAY be included as an option) (BRouter adds elevation to "geometry":"coordinates"[2], but gdal-ogr2ogr adds elevation as "properties":"ele"); my design decision is to discard elevations for now to avoid inconsistencies and conflicts. It may be added in a later date.
